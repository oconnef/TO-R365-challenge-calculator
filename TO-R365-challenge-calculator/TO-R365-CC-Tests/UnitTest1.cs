namespace TO_R365_CC_Tests
{
    public class Tests
    {
        private TOCalculator.CalculatorOLD _calc;
        ...
        public void Setup()
        {
            _calc = new TOCalculator.CalculatorOLD(1000, '/', delimiterAnyLength, false, _delimiters);
        }
        ...
        {
            string input = "4,-3";
            _calc = new TOCalculator.CalculatorOLD(1000, '/', delimiterAnyLength, true, _delimiters);
            _calc.ParseInput(_dummyCustomDelimiter, input);
